// ========LOOP FOR CREATING ALL 'person' elements on page========

for (var i = 0; i < customers.results.length; i += 1) {

  // =========PULLS HTML INTO JS ASSIGNS IT TO JS VARIABLE customerID======
  let customerID = document.querySelector("#customer")

  // ======CREATES A DIV INSIDE OF HTML. ALL OTHER CONTAINERS WILL BE INSIDE THIS DIV=====
  let customerChild = document.createElement('div');

  // ====='person' REPRESENTS ALL INNERHTML======
